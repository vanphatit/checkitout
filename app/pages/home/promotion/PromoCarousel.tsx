...
import PromoCodeCard from "@/app/components/promotion/PromotionCard";
  ...
  return (
    <RootLayout className="space-y-12">
      ...
      <div className="w-full flex items-center justify-center text-center">
        <h1 className="text-3xl font-bold text-neutral-800 dark:text-secondary">
        ...
        <div className="overflow-hidden">
          ...
          >
            {promos.map((promo) => (
              <div
                key={promo.id}
                className="flex-shrink-0 w-[calc(33.333%-1.22rem)]"
              >
                <PromoCodeCard
                  title={promo.title}
                  code={promo.code}
