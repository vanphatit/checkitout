...
export default function SchedulingPage() {
    ...
    const [selectedDate, setSelectedDate] = useState(searchParams.get("date") || getCurrentDate());
        ...
        const observer = new IntersectionObserver(
            entries => {
                if (entries[0].isIntersecting && hasMore && !isLoading) {
                    ...
                    setPage(nextPage);
                    fetchSchedulings(nextPage, selectedDate, fromLocation, toLocation, false);
                }
            },
            { threshold: 0.1 }
        );
    ...
    }, [hasMore, isLoading, page, selectedDate, fromLocation, toLocation, fetchSchedulings]);
                ...
                <div className="mt-8">
                        ...
                        <div ref={observerTarget} className="flex justify-center py-8">
                            {isLoading && page > 1 && (
                                <div className="flex items-center gap-2">
                                    ...
                                    <p className="text-neutral-600 dark:text-neutral-400">Đang tải thêm...</p>
                                </div>
                            )}
                        </div>
                    )}
                    ...
                    {!hasMore && schedulings.length > 0 && (
                        <div className="text-center py-8">
                            <p className="text-neutral-500 dark:text-neutral-400">Đã hiển thị tất cả lịch trình</p>
                        </div>
                    )}
                </div>
            </Container>
